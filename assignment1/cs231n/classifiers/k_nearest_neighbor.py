...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                diff = X[i] - self.X_train[j]   # difference vector
                dists[i, j] = np.sqrt(np.sum(diff ** 2))  # L2 distance
                #####################################################################
                # TODO:                                                             #
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            dists[i, :] = np.sqrt(np.sum(diff**2, axis=1))  # L2 distances to all training points
            pass
        return dists
